...
configRoutes = function ( app, server )
{
	...
	{
		dbHandle.collection(
			request.params.obj_type, // = ":obj_type" = "user" = MongoDb's collection.
			function ( outer_error, collection ) // Parameters "outer_error, collection" are handed over in dbHandle.collection.
			{
