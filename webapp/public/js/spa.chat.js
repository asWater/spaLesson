...
spa.chat = (function ()
{
	...
	var
		...
		setJqueryMap, setPxSizes, setSliderPosition, //getEmSize,
		scrollChat, writeChat, writeAlert, clearChat,
		onTapToggle, onSubmitMsg, onTapList, onSetchatee, onUpdatechat, onListchange,
		onLogin, onLogout, //onClickToggle, 
...
// Because this is available from "spa.util_b.js", does not necessary anymore. 
...
//	};
	...
	setSliderPosition = function ( position_type, callback )
	{
		...
		// Position type "opened" can not be used for anonymouse user, so returns false.
		// The shell adjust URI and try again.
	...
	// Private DOM method to manage chat messages
	scrollChat = function ()
	{
		var 
	...
	onSetchatee = function ( event, arg_map )
	{
		...
		if ( ! new_chatee )
		{
			...
			{
				writeAlert( 'Your friend has left hte chat' );
			}
	...
	initModule = function ( $append_target )
	{
		...
		// Register to jQuery Global Events with using $list_box.
		...
		// Bind user's input events.
		// Binding before registration might trigger conflicts.
	...
	// [Objective]: 
	// 	- Remove DOM element "chatSlider".
	// 	- Initialize.
	// 	- Remove callbacks and data pointers to other data.
	// [Parameters]: none.
	// [Return value]: true.
	// [Exception]: none.
	// 
	...
	{
		// Initialization and release condition.
	...
	// [Objective]:
	// 	- If necessary, adjust display provided by this module according to window resize event.
	// [Behavior]: 
	// 	- Change the size of chat slider according to shirinked window size, when the width/height is under the certain threshhold.
	// [Return Value]:
	//  - false: Resize is not taken into account.
	//  - true: Resize is taken into account.
	// [Exception]: none.
	// 
